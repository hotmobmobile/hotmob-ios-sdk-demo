//
//  HMVideoInterstitialViewController.swift
//  HotmobiOSSDKDemo
//
...
class HMVideoInterstitialViewController: HMBaseViewController, UITableViewDelegate, HMUIViewTapDelegate {
    ...
    var mainViewModel: HMVideoInterstititalViewModel? = HMVideoInterstititalViewModel()
    
    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        self.title = "Video Interstitial"
    ...
    deinit{
        print("deinit HMVideoInterstitialViewController")
    }
...
extension HMVideoInterstitialViewController: UICollectionViewDataSource{
...
extension HMVideoInterstitialViewController: UICollectionViewDelegateFlowLayout{
